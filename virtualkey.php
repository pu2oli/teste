...
echo '<table>';
echo '	<tr>';
echo '		<td><input type="button" class="form-control" id="A" onclick="GetKey(this)" value="[' . $a[0] . '/'. $a[1] . ']"/></td>';
echo '		<td><input type="button" class="form-control" id="B" onclick="GetKey(this)" value="[' . $a[2] . '/'. $a[3] . ']"/></td>';
echo '		<td><input type="button" class="form-control" id="C" onclick="GetKey(this)" value="[' . $a[4] . '/'. $a[5] . ']"/></td>';
echo '	</tr>';
echo '	<tr>';
echo '		<td><input type="button" class="form-control" id="D" onclick="GetKey(this)" value="[' . $a[6] . '/'. $a[7] . ']"/></td>';
echo '		<td><input type="button" class="form-control" id="E" onclick="GetKey(this)" value="[' . $a[8] . '/'. $a[9] . ']"/></td>';
echo '		<td><input type="button" class="form-control" id="F" onclick="GetKey(this)" value="[<<]"/></td>';
echo '	</tr>';
echo '</table>';
